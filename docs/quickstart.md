...
Download the latest release of Draft from the [latest releases page](https://github.com/BeardyC/draft/releases/latest), unpack the binary and place it somewhere on your $PATH.
