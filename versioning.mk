...
LDFLAGS += -X github.com/BeardyC/draft/pkg/version.Version=${GIT_TAG}
LDFLAGS += -X github.com/BeardyC/draft/pkg/version.GitCommit=${GIT_COMMIT}
LDFLAGS += -X github.com/BeardyC/draft/pkg/version.GitTreeState=${GIT_DIRTY}
